...
namespace dynamic_balancing_machine.User_control
{
    public partial class DataAcquisition : UserControl
    {
        ...
        private void btnConnect_Click(object sender, EventArgs e)
        {
            ...
            catch { MessageBox.Show("Please change COM Port"); }
        ...
        private void serialPort1_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            if (bufferSize > 12000)
            {
                ...
                {
                    int k = j * 6;
                    quang[j] = ((ints[k]) * 256 + ints[k + 1]) / 10000;
                    piezo1[j] = ((ints[k + 2]) * 256 + ints[k + 3]) / 10000;
                    piezo2[j] = ((ints[k + 4]) * 256 + ints[k + 5]) / 10000;
                }
                ...
                if (Mode == 1)
                {
                    ...
                    Array.Clear(piezo1, 0, piezo.Length);
                    time = 0;
            ...
            TextBox txtAmAverage, TextBox txtAnphaAverage, TextBox txtDolechpha)
        {
            try
            {
                ...
                // xuất tốc độ vật mẫu;
                txtRateobject.Text = (piezo1.Length / ((cbquang[1] - cbquang[0]) * time / 1000 / 60)).ToString("0.000");
